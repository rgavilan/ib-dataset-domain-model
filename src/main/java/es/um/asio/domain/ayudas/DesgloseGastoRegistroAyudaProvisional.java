...
/**
 * Class that represents the mapping of the file "Desglose gastos registro ayudas provisionales.xml"
 */
@Entity
@Getter
@Setter
...
public class DesgloseGastoRegistroAyudaProvisional extends OperationableDataSetDataBase {  
