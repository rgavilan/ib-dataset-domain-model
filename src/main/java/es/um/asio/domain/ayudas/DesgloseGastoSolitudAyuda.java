...
/**
 * Class that represents the mapping of the file "Desglose gastos solicitudes ayuda.xml"
 */
@Entity
@Getter
@Setter
...
public class DesgloseGastoSolitudAyuda extends OperationableDataSetDataBase {  
